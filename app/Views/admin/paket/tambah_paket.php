    ...
    <div class="col-12">
        <div class="block block-bordered">
            <div class="block-header bg-info px-4 d-flex">
                ...
                <span class="ms-3 me-auto text-white fs-5 fw-semibold">Tambah Paket Baru</span>
            </div>
            <div class="block-content">
                <form action="<?= route_to('admin.paket.tambah_paket.post') ?>" method="post" class="form-paket">
                    <?= csrf_field() ?>
                    <div class="row mb-lg-4">
                        <div class="col-12 col-lg-3 mb-4 mb-lg-0">
                            <div class="form-floating">
                                <input type="text" class="form-control fw-semibold" id="nama_paket" name="nama_paket" placeholder="" value="<?= old('nama_paket') ?>">
                                <label class="form-label" for="nama_paket">Nama Paket</label>
                            </div>
                        </div>
                        <div class="col-12 col-lg-3 mb-4 mb-lg-0">
                            <div class="form-floating">
                                <input type="text" class="form-control fw-semibold" id="harga_paket" name="harga_paket" placeholder="" value="<?= old('harga_paket') ?>">
