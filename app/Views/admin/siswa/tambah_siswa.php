    ...
    <div class="col-12">
        <div class="block block-bordered">
            ...
            <div class="block-content">
                <form action="<?= route_to('admin.siswa.tambah_siswa.post') ?>" method="post" class="form-siswa">
                    <?= csrf_field() ?>
                    <div class="row mb-lg-4">
                        <div class="col-12 col-lg-6 mb-4 mb-lg-0">
                            <div class="form-floating">
                                <input type="text" class="form-control fw-semibold" id="nama_siswa" name="nama_siswa" placeholder="" value="<?= old('nama_siswa') ?>">
                                <label class="form-label" for="nama_siswa">Nama Lengkap Siswa</label>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6 mb-4 mb-lg-0">
                            <div class="form-floating">
                                <input type="text" class="form-control fw-semibold" id="sekolah" name="sekolah" placeholder="" value="<?= old('sekolah') ?>">
                    ...
                    <div class="row mb-lg-4">
                        <div class="col-12 col-lg-6 mb-4 mb-lg-0">
                            <div class="form-floating">
                                <input type="text" class="form-control fw-semibold" id="nama_ortu" name="nama_ortu" placeholder="" value="<?= old('nama_ortu') ?>">
                                <label class="form-label" for="nama_ortu">Nama Orang Tua</label>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6 mb-4 mb-lg-0">
                            <div class="form-floating">
                                <input type="text" class="form-control fw-semibold" id="hp_ortu" name="hp_ortu" placeholder="" value="<?= old('hp_ortu') ?>" pattern="^\d{10,13}$">
