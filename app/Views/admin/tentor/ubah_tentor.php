...
<div class="col-12">
    <div class="block block-bordered">
        <div class="block-header bg-primary px-4 d-flex">
            <a href="<?= url_to('admin.tentor.tentor_aktif') ?>" class="fa fa-arrow-circle-left text-white fs-3"></a>
            <span class="ms-3 me-auto text-white fs-5 fw-semibold">Ubah Tentor</span>
        </div>
        <div class="block-content">
            <form action="<?= url_to('admin.tentor.ubah_tentor.post') ?>" method="post" class="form-tentor">
                <?= csrf_field() ?>
                <?= form_hidden('id_pengajar', $tentor->id_pengajar) ?>
                <div class="row mb-lg-4">
                    <div class="col-12 col-lg-8 mb-4">
                        <div class="form-floating">
                            <input type="text" class="form-control fw-semibold" id="nama_pengajar" name="nama_pengajar" placeholder="" value="<?= $tentor->nama_pengajar ?>">
                            <label class="form-label" for="nama_pengajar">Nama Lengkap Tentor</label>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 mb-4">
                        <div class="form-floating">
                            <input type="text" class="form-control fw-semibold" id="nomor_hp" name="nomor_hp" placeholder="" value="<?= $tentor->nomor_hp ?>">
                            <label class="form-label" for="nomor_hp">Nomor HP</label>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 mb-4">
                        <div class="form-floating">
                            <input type="email" class="form-control fw-semibold" id="email_bimbel" name="email_bimbel" placeholder="" value="<?= $tentor->email_bimbel ?>">
                            <label class="form-label" for="email_bimbel">Email Bimbel</label>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 mb-4">
                        <div class="form-floating">
                            <input type="email" class="form-control fw-semibold" id="email_pribadi" name="email_pribadi" value="<?= $tentor->email_pribadi ?>" placeholder="">
                            <label class="form-label" for="email_pribadi">Email Pribadi</label>
                        </div>
                    </div>
                    <div class="col-12 mb-4">
                        <div class="form-floating">
                            <input type="text" class="form-control fw-semibold" id="alamat" name="alamat" value="<?= $tentor->alamat ?>" placeholder="">
