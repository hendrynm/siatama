...
<div class="col-12">
    <div class="block block-bordered">
        <div class="block-header bg-primary px-4 d-flex">
            ...
            <span class="ms-3 me-auto text-white fs-5 fw-semibold">Tambah Penilaian</span>
        </div>
                ...
                <div class="row mb-4">
                    <div class="col-12 col-md-2">
                        <div class="form-floating">
                            ...
                            <label class="form-label" for="tatap_muka">Penilaian Ke-</label>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 mt-4 mt-md-0">
                        <div class="form-floating">
                            <select class="form-select" id="mentor" name="mentor" size="1" required>
                                ...
                                <option value="3">Keaktifan</option>
                            </select>
                            <label class="form-label" for="mentor">Jenis Penilaian</label>
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
