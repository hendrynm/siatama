...
<div class="col-12">
    <div class="row mb-4">
        <div class="col-12">
            <div class="fs-1 fw-semibold">
                <a href="<?= route_to('admin.penilaian.index') ?>" class="fa fa-arrow-circle-left fa-1x pe-2"></a>
    ...
    <div class="row align-middle">
        <div class="col-12 col-md-6 col-xl-3">
            <a class="block block-link-pop block-link-shadow text-end" href="<?= route_to('admin.penilaian.lihat_kelas') ?>">
