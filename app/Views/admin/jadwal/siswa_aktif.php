...
<div class="col-12">
    <div class="block block-bordered">
        <div class="block-header bg-primary px-4 d-flex">
            ...
            <span class="ms-3 me-auto text-white fs-5 fw-semibold">Jadwal Les per Siswa</span>
        </div>
        <div class="block-content block-content-full">
            <!-- DataTables functionality is initialized with .js-dataTable-full class in js/pages/be_tables_datatables.min.js which was auto compiled from _js/pages/be_tables_datatables.js -->
            <div class="table-responsive p-1">
                <table class="table table-bordered table-hover table-vcenter datatable-datasiswa">
                    <thead>
