...
<div class="col-12">
    <div class="block block-bordered">
        <div class="block-header bg-primary px-4 d-flex">
            <a href="<?= route_to('admin.mentor.mentor_aktif') ?>" class="fa fa-arrow-circle-left text-white fs-3"></a>
            <span class="ms-3 me-auto text-white fs-5 fw-semibold">Tambah Tentor Baru</span>
        </div>
        <div class="block-content">
            <form action="<?= route_to('admin.mentor.ubah_mentor') ?>" method="post">
                <div class="row mb-lg-4">
                    <div class="col-12 col-lg-6 mb-4 mb-lg-0">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="nama_mentor" name="nama_mentor" placeholder="">
                            <label class="form-label" for="nama_mentor">Nama Lengkap Tentor</label>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 mb-4 mb-lg-0">
                        <div class="form-floating">
