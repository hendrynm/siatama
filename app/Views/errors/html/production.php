            ...
            <div class="hero-inner">
                <div class="content content-full">
                    <div class="py-4 text-center">
                        ...
                        <h1 class="fw-bold mt-5 mb-2">Server Aplikasi Error</h1>
                        <h2 class="fs-4 fw-medium text-muted mb-5 mt-3">Maaf, permintaan kamu tidak dapat diproses. Mohon laporkan masalah ini ke Pengembang.</h2>
